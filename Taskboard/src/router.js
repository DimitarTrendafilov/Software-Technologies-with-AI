...
const routes = [
  ...
  { path: '/admin', load: () => import('./pages/admin/admin.js') },
  ...
  { path: '/projects/:id/labels', load: () => import('./pages/project-labels/project-labels.js') },
  { path: '/projects/:id/deadlines', load: () => import('./pages/project-deadlines/project-deadlines.js') },
  { path: '/projects/:id/activity', load: () => import('./pages/project-activity/project-activity.js') },
  { path: '/project/:id/labels', load: () => import('./pages/project-labels/project-labels.js') },
  { path: '/project/:id/deadlines', load: () => import('./pages/project-deadlines/project-deadlines.js') },
  { path: '/project/:id/activity', load: () => import('./pages/project-activity/project-activity.js') },
